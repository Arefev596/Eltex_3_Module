...
int main(int argc, char * argv[]) { /////// добавил параметры
	...
	/* Основной цикл обслуживания*/
		...
		if(sendto(sockfd, sendline, strlen(sendline) + 1, 0, (struct sockaddr *) &cliaddr, sizeof(cliaddr)) < 0){
